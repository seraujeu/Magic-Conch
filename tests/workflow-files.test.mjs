...
import { workflowArchiveFilename, workflowExportFilename, workflowFileText } from "../lib/workflow-files.ts";
...
test("uses a zip extension for workflow exports with files", () => {
  assert.equal(workflowArchiveFilename("研究 흐름"), "研究-흐름.zip");
});
