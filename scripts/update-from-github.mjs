...
function verifyProtectedPaths(git, candidateRevision) {
...
export function main(argv = process.argv.slice(2)) {
  ...
  const needsRecovery = existsSync(updateTransactionPath(projectRoot));
